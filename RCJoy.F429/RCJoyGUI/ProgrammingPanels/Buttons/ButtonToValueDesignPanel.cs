...
{
    public partial class ButtonToValueDesignPanel : DraggableElement
    {
        private int _DataIndex = -1;
        private readonly List<ButtonToValuePanel> __Panels = new List<ButtonToValuePanel>(12);
        
        public ButtonToValueDesignPanel()
        {
            InitializeComponent();
        ...
        {
            var panel = new ButtonToValuePanel();
        ...
        {
            return new XElement("ButtonsToValues");
        }
