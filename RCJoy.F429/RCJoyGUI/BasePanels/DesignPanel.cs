...
using Tahorg.RCJoyGUI.ProgrammingPanels.Buttons;
...
namespace Tahorg.RCJoyGUI
{
    public partial class DesignPanel : UserControl, ILinkResolver, IFRAMUser
    {
        ...
        public XElement Serialize()
        {
            ...
            {
                var xpanel = element.CreatXMLSave();
                element.Serialize(xpanel);
                xpanels.Add(xpanel);
            }
        ...
        public void SetModel(ModelInfo model)
        {
            ...
            joystickToolStripMenuItem.DropDownItems.Clear();
            joystickToolStripMenuItem.DropDownItems.AddRange(
                fmMain.JoyInfos.Select(joy => new ToolStripMenuItem(joy.Name, null, joystickToolStripMenuItem_Click) { Tag = joy.ID }).Cast<ToolStripItem>().ToArray()
                );
        ...
        private void CreatePanel(XName panelName, XElement xElement)
        {
            switch (panelName.ToString())
            {
                ...
                case "LogicalOrButton":
                    {
                        var panel = new LogicalOrButtonDesignPanel();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }
                ...
                case "AilRudderMixerStored":
                    {
                        var panel = new AilronToRudderMixerDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "DeltaMixerStored":
                    {
                        var panel = new DeltaMixerDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "FlaperonsMixerStored":
                    {
                        var panel = new FlaperonMixerDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "ThRudderMixerStored":
                    {
                        var panel = new ThrottleToElevMixerDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "VTailMixerStored":
                    {
                        var panel = new VTailMixerDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "ButtonsToValues":
                    {
                        var panel = new ButtonToValueDesignPanel();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }
                ...
                case "ExponentStored":
                    {
                        var panel = new ExponentDesignPanelStored();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }
                ...
                case "ThrottleCut":
                    {
                        var panel = new ThrottleCutDesignPanel();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }

                case "MultiButtonHoldPanel":
                    {
                        var panel = new MultiButtonHoldDesignPanel();
                        panel.Deserialize(xElement);
                        LinkPanel(panel, true);
                        break;
                    }
        ...
        private void flaperonsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            LinkPanel(new FlaperonMixerDesignPanelStored());
        }

        private void alieronsRudderToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LinkPanel(new AilronToRudderMixerDesignPanelStored());
        ...
        private void throttleElevatorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            LinkPanel(new ThrottleToElevMixerDesignPanelStored());
        }

        private void throttleCutToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LinkPanel(new ThrottleCutDesignPanel());
        ...
        private void centeredExpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            LinkPanel(new ExponentDesignPanelStored() { Centered = true });

        }

        private void rangeExpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LinkPanel(new ExponentDesignPanelStored() { Centered = false });
        ...
        private void logicalButtonORToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LinkPanel(new LogicalOrButtonDesignPanel());
        }
        ...
        private void multiHoldSwitchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LinkPanel(new MultiButtonHoldDesignPanel());
        ...
        {
            LinkPanel(new ButtonToValueDesignPanel());
        }
        ...
        public void TakeJoyData(byte[] jdata)
        {
            foreach (var element in __Elements)
