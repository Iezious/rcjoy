...
bool ListScrollUp()
{
	uint16_t total = VarsList.Height / VarsListBox.ItemHeight;
	if (VarsListBox.TopVisible < total)
		VarsListBox.TopVisible = 0;
	else
		VarsListBox.TopVisible -= total;
...
bool ListScrollDown()
{
	...
	if (VarsListBox.TopVisible > VarsListBox.Length - total)
		VarsListBox.TopVisible = VarsListBox.Length - total;
