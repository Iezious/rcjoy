...
#Additional flags
PREPROCESSOR_MACROS += stm32_flash_layout STM32F107VC STM32F10X_CL
...
LDFLAGS += -mcpu=cortex-m3 -mthumb  -T$(BSP_ROOT)/STM32F1xxxx/LinkerScripts/STM32F107xC_flash.lds
COMMONFLAGS += 
