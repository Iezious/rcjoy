...
#if STM32
        void GenerateSTMCode(STMProgram prg, ref ushort BlockStart);
#endif
    }
...
#if STM32
        public void GenerateSTMCode(STMProgram prg, ref ushort BlockStart)
        {
    ...
    public class ButtonsCollection : IJoystickControl
    {
        ...
        public void GenerateSTMCode(STMProgram prg, ref ushort BlockStart)
        {
            for (var i = 0; i < ButtonsCount; i++)
            {
                ...
                prg.CommonCode.Add(
                    0x02, (short) (BlockStart), (short)(_DataIndex + i)
                );
...
//                throw new CompilationCheckException("Joystick check fails, wrong hat min value", CompilationCheckException.CompileIteration.PreCheck);
        ...
        public void GenerateSTMCode(STMProgram prg, ref ushort BlockStart)
        {
            prg.CommonCode.Commands.Add(new STMCommand(
                0x03, (short)BlockStart, (short)Length, (short)_DataIndex, (short)(_DataIndex+1)
            ));
        }
#endif
...
//            Counter = 0;
    ...
    public class JoystickConfig
    {
        ...
        public static JoystickConfig LoadFromXML(XDocument file)
        {
            if (file == null || file.Root == null) return null;

            XElement data = file.Root.Element("Joystick");
            return data == null ? null : new JoystickConfig(data);
        }
        ...
        public XElement Serialize()
        {
            var xel = new XElement("Joystick", new XAttribute("Name", Name), new XAttribute("Code", Code));
